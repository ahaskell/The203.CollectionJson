...
namespace The203.CollectionJson.Core.Links
{
    public interface ILinkBuilder<TAnchor>
    {
	   ...
	   ILinkBuilder<TAnchor> AddChildCollectionAlways<TChild>(string rel, Func<TAnchor, IEnumerable<TChild>> getChildren);
	   ILinkBuilder<TAnchor> AddChild<TChild>(string rel, Func<TAnchor, TChild> getChild);
	   ILinkBuilder<TAnchor> AddChild(string rel, string relativeUri);
	   ILinkBuilder<TAnchor> AddChildAlways<TChild>(string rel, Func<TAnchor, TChild> getChild);
	   ILinkBuilder<TAnchor> AddChildGroup<TGroupType>(Func<TGroupType, String> relationResolver, Func<TAnchor, IEnumerable<TGroupType>> getRelatedGroup, Func<TGroupType, String> resolveItemId);
	   ILinkBuilder<TAnchor> AddChildGroup<TGroupType>(Func<TGroupType, String> relationResolver, Func<TAnchor, IEnumerable<TGroupType>> getRelatedGroup, Func<TGroupType, String> resolveItemId, String tackOnUrl);
