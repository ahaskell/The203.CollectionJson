...
namespace The203.CollectionJson.Core.Links
{
    ...
    public class LinkBuilder<TAnchor> : ILinkBuilder<TAnchor>
    {
	   ...
	   public ILinkBuilder<TAnchor> AddChildCollectionAlways<TChild>(string rel, Func<TAnchor, IEnumerable<TChild>> getChildren)
	   {
		  this.linkBuilders.Add(new CollectionLinkBuilderItem<TAnchor, TChild>(rel, getChildren, LinkBuilderUrlType.OriginalItem).Always());
		  return this;
	   }
	   ...
	   public ILinkBuilder<TAnchor> AddChild(string rel, string relativeUrl)
	   {
		  this.linkBuilders.Add(new ItemLinkBuilderItem<TAnchor, String>(rel, item => relativeUrl, LinkBuilderUrlType.OriginalItem, relativeUrl));
		  return this;
	   }
	   public ILinkBuilder<TAnchor> AddChildGroup<TGroupType>(Func<TGroupType, String> relationResolver,
												   Func<TAnchor, IEnumerable<TGroupType>> getRelatedGroup,
												   Func<TGroupType, String> resolveItemId)
	   {
		  return AddChildGroup(relationResolver, getRelatedGroup, resolveItemId, "");
	   }
	   public ILinkBuilder<TAnchor> AddChildGroup<TGroupType>(Func<TGroupType, String> relationResolver, Func<TAnchor, IEnumerable<TGroupType>> getRelatedGroup, Func<TGroupType, String> resolveItemId, String tackOnUrl)
	   {
		  this.linkBuilders.Add(new CollectionLinkBuilderCollection<TAnchor, TGroupType>(relationResolver, getRelatedGroup, resolveItemId, LinkBuilderUrlType.OriginalItem, tackOnUrl));
		  return this;
	   }
